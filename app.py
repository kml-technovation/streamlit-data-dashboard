...
# create a pie chart for streaming services breakdown
...
# pie chart on how music effected mental health
def music_effects_piechart():
    ...
    fig.update_layout(title=dict(font=dict(size=28)), autosize=True)
    st.plotly_chart(fig, use_container_width=True )
...
# box plot of mental health issues
...
#creates 4 graphs, one for each of the mental health issues included
...
# service piechart filtered by age
...
# bar chart by age, filtered by condition
